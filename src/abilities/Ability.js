...
Ability.prototype.getHastedCooldown = function(){
  var hasteModifier = 1 + this.paladin.stats.buffed.hastePercent;
...
Ability.prototype.multistrike = function(ability, damage){
  ...
  if(utils.isMultistrike(this.paladin.stats.buffed.multistrikePercent)){
...
Ability.prototype.applyHandOfLight = function(damage){
  ...
  var modifier = this.paladin.stats.buffed.masteryPercent;
...
Ability.prototype.versatility = function(damage){
  return damage * (1 + this.paladin.stats.buffed.versatilityPercent);
}
